...
- Name: server/tests/integration/create-transactions.spec.ts >> POST /transactions API >> should create a transaction successfully with valid data
- Location: server/tests/integration/create-transactions.spec.ts:7:3
