...
- Name: server/tests/integration/create-transactions.spec.ts >> POST /transactions API >> should return 400 if required field "amount" is missing
- Location: server/tests/integration/create-transactions.spec.ts:30:3
